...
public class CountrySymbols implements CountryFlagAssetProvider {
    ...
    private CountrySymbols(Builder builder) {
        ...
        flagSpriteBitMap = builder.flagSpriteBitMap != null ?
                ...
                getImageFromAssetsFile(context, "country_sprite_flags.png");
     ...
     */
    public BitmapDrawable getCountryFlagIcon(String countryCode) throws FlagsException {
        if (context == null) {
    ...
    public static class Builder {
         ...
         */
        public CountrySymbols build() {
            return new CountrySymbols(this);
        }
