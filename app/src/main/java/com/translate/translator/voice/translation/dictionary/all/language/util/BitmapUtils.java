...
public final class BitmapUtils {
    ...
    public static BitmapSampled decodeSampledBitmap(Context context, Uri uri, Rect rect, int reqWidth, int reqHeight) {
     ...
     * @param sampleMulti used to increase the sampling of the image to handle memory issues.
     */
    public static BitmapSampled decodeSampledBitmapRegion(
