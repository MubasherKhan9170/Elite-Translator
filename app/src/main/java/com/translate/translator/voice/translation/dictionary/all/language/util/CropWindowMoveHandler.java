...
public final class CropWindowMoveHandler {
    ...
    /**
     * @paramedgeMoveType the type of move this handler is executing
     * @paramhorizontalEdge the primary edge associated with this handle; may be null
     * @paramverticalEdge the secondary edge associated with this handle; may be null
     ...
     *     edges.
     * @paramparentView the parent View containing the image
