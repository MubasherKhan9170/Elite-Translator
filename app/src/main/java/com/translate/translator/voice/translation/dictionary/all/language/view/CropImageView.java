package com.translate.translator.voice.translation.dictionary.all.language.view;
...
import com.translate.translator.voice.translation.dictionary.all.language.util.BitmapUtils;
import com.translate.translator.voice.translation.dictionary.all.language.util.CropImageAnimation;
import com.translate.translator.voice.translation.dictionary.all.language.util.CropImageOptions;
...
public class CropImageView extends FrameLayout {
   ...
   //private WeakReference<BitmapLoadingWorkerTask> mBitmapLoadingWorkerTask;
    ...
    public void setImageBitmap(Bitmap bitmap, int rotationDegree) {
        mCropOverlayView.setInitialCropWindowRect(null);
        setBitmap(bitmap, 0, null, 1, rotationDegree);
       // mProgressBar.setVisibility(GONE);
...
//    }
     ...
     * #setOnCropImageCompleteListener(OnCropImageCompleteListener)}.
     *
     * @paramreqWidth the width to resize the cropped image to (see options)
     * @paramreqHeight the height to resize the cropped image to (see options)
     * @paramoptions the resize method to use on the cropped bitmap
     * @paramsaveUri optional: to save the cropped image to
     * @paramsaveCompressFormat if saveUri is given, the given compression will be used for saving
     *     the image
     * @paramsaveCompressQuality if saveUri is given, the given quality will be used for the
     *     compression.
     */
...
/*        if (mBitmapLoadingWorkerTask != null) {
    ...
    private void setProgressBarVisibility() {
        boolean visible = mShowProgressBar && (mBitmap == null);
